...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a1s5kefat7kh52.iot.eu-central-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "HeartDataDetector" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "HeartDataDetector" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "root.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "e19549a608-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "e19549a608-private.pem.key" ///< Device private key filename
// =================================================
